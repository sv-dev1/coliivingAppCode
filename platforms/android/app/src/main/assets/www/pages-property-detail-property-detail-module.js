...
var PropertyDetailPage = /** @class */ (function () {
    function PropertyDetailPage(route, http, loadingController) {
        var _this = this;
        this.route = route;
        this.http = http;
    ...
    PropertyDetailPage.prototype.getPropertyInfo = function () {
        var _this = this;
        var token;
    ...
    PropertyDetailPage.prototype.presentLoading = function () {
