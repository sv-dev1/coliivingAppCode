...
var HouseChoresPage = /** @class */ (function () {
    function HouseChoresPage(router, http, formBuilder, itemService, alertController, loadingController, navCtrl, popoverController, datepipe) {
        this.router = router;
        this.http = http;
    ...
    HouseChoresPage.prototype.ngOnInit = function () {
        ...
        this.presentDate = this.datepipe.transform(latest_date, 'yyyy-MM-dd');
        ...
        this.http.get(this.base_url + 'tasks', { headers: headers }).subscribe(function (response) {
            response.tasks.forEach(function (obj) {
                if (obj['task.task_name'] != null) {
                    _this.tasksListArr.push(obj);
                }
            });
            console.log(_this.tasksListArr);
