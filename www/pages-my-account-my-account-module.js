...
var MyAccountPage = /** @class */ (function () {
    function MyAccountPage(router, http, formBuilder, itemService, alertController, loadingController, camera, actionSheetController, datepipe, renderer) {
        this.router = router;
        this.http = http;
            ...
            return __generator(this, function (_a) {
                ...
                this.http.get(this.base_url + 'user/profile', {
                    ...
                    _this.update_form.patchValue({
                        ...
                        favourite_locations: _this.userDataArr.favourite_location,
                    ...
                    console.log(_this.update_form.value);
                    _this.image_url = _this.image_base_url + '' + _this.userDataArr.userId;
                    var fileName = _this.image_base_url + '' + 'documents/' + _this.userDataArr.userId;
    ...
    MyAccountPage.prototype.register = function (form) {
        ...
        if (this.update_form.invalid) {
            ...
            formData.append('dob', this.datepipe.transform(input_data.dob, 'yyyy-MM-dd'));
    ...
    MyAccountPage.prototype.changeListener = function (event) {
        ...
        this.http.post(this.base_url + 'user/documents', formData, httpOptions).subscribe(function (response) {
            console.log(response);
            _this.addedMessage();
            _this.loadingController.dismiss().then(function (a) { return console.log('dismissed'); });
        }, function (error) {
    ...
    MyAccountPage.prototype.addedMessage = function () {
        return __awaiter(this, void 0, void 0, function () {
            var loading;
            return __generator(this, function (_a) {
                switch (_a.label) {
