...
var GroupSummaryPagePage = /** @class */ (function () {
    ...
    GroupSummaryPagePage.prototype.getBillListing = function () {
        ...
        this.http.get(this.base_url + 'team/bills/summary/' + this.teamId, {
            ...
            _this.getBalanceRecord(_this.billsArr);
            ...
            _this.positiveUser.forEach(function (obj) {
                var amount = Number(obj.paid) - Number(obj.amount);
    ...
    GroupSummaryPagePage.prototype.getBalanceRecord = function (record) {
        var _this = this;
        // console.log(record);
        var userInfo = [];
        var useramt = [];
        ...
        userInfo.forEach(function (ele) {
            ele.forEach(function (item) {
                if (!useramt.find(function (o) { return o.userId === item.userId; })) {
                    var obj = {};
                    obj['userId'] = item.userId,
                        obj['amount'] = item.amount,
                        obj['userName'] = item.userProfile.login['username'],
        ...
        console.log(posUser);
        console.log(negUser);
        negUser.forEach(function (obj, i) {
            posUser.forEach(function (ele, index) {
                ...
                if (parseFloat(ele.amountToPay) < parseFloat(obj.amountToPay)) {
                    ...
                    if (parseFloat(ele.amountToPay) != 0) {
                        ...
                        var amt = obj.amountToPay - ele.amountToPay;
                    ...
                    if (parseFloat(ele.amountToPay) != 0) {
                        ...
                        _this.balancedAmount.push(post);
                        obj.amountToPay = 0;
                        var amount = ele.amountToPay - obj.amountToPay;
